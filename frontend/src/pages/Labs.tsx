...
export default function Labs() {
    ...
    const [fileTransferLab, setFileTransferLab] = useState<Lab | null>(null);
    ...
    return (
        <div className="space-y-6">
                                    ...
                                    >
                                        ...
                                        <div className="flex gap-2 mt-auto pt-2 border-t">
                                            ...
                                            <Button
                                                variant="outline"
                                                size="sm"
                                                onClick={() => setFileTransferLab(lab)}
            ...
            {fileTransferLab && (
                <FileTransferDialog
                    open={!!fileTransferLab}
                    onOpenChange={(open) => !open && setFileTransferLab(null)}
                    targets={{ labs: [fileTransferLab.id] }}
                />
            )}
        </div>
    );
