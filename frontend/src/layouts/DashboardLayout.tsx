...
import { LayoutDashboard, Monitor, Server, LogOut, Package, FileText, Download, Database, Users, Shield, AlertTriangle, Settings, Activity, Clock as ClockIcon } from 'lucide-react';
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <aside className="w-64 bg-white border-r hidden md:flex md:flex-col">
                ...
                <nav className="space-y-1 px-4 flex-1">
                    ...
                    <Link to="/admin/schedules" className="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-md">
                    ...
                    <Link to="/admin/system-health" className="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-md">
